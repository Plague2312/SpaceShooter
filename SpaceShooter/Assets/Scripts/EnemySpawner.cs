...
public class EnemySpawner : MonoBehaviour
{
    ...
    public float enemyDefaultPadding; //padding position of eaach enemy
    ...
    void Start()
    {
        ...
        Invoke("SpawnEnemy", 1f / enemySpawnPerSecond); //call SpawnEnemy method after a time delay
    }//end start()
    ...
    void SpawnEnemy()
    {
        ...
        { enemyPadding = System.Math.Abs(go.GetComponent<BoundsCheck>().radius); }
